...
+ (MB_INSTANCETYPE)showHUDAddedTo:(UIView *)view animated:(BOOL)animated :(NSString *)textLoading {
	MBProgressHUD *hud = [[self alloc] initWithView:view];
    hud.labelText = textLoading;
	[view addSubview:hud];
	[hud show:animated];
...
+ (BOOL)hideHUDForView:(UIView *)view animated:(BOOL)animated afterDelay:(NSTimeInterval)delay{
